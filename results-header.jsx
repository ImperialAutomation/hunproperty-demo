// results-header.jsx — shared header used on the results page.
  ...
  return (
    <header style={{
      ...
      <div style={{
        ...
        {/* Breadcrumb / context */}
        <div style={{ display: "flex", alignItems: "center", gap: 10, fontSize: 13, color: "var(--muted)", flex: 1, justifyContent: "center" }}>
